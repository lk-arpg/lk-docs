# v2.1.x
This page contains all updates between the version 2.1.0 of Lorekeeper and version 2.1.9.
...
## v2.1.9 (Hotfix)
[Release notes](https://github.com/lk-arpg/lorekeeper/releases/tag/v2.1.9)
### Bug Fixes
- hotfix: update socialiteproviders/deviantart to ^4.2 by ([perappu](https://github.com/perappu)) ([PR #1450](https://github.com/lk-arpg/lorekeeper/pull/1450))

## v2.1.10 (Hotfix)
[Release notes](https://github.com/lk-arpg/lorekeeper/releases/tag/v2.1.10)
### Bug Fixes
...
### Bug Fixes
- fix: suppress irrelevant/duplicate security advisories by ([perappu](https://github.com/perappu)) ([PR #1505](https://github.com/lk-arpg/lorekeeper/pull/1505))

## v2.1.12 (Hotfix)
[Release notes](https://github.com/lk-arpg/lorekeeper/releases/tag/v2.1.12)
### Bug Fixes
- fix: suppress duplicate security advisory for PKSA-mdq4-51ck-6kdq by ([perappu](https://github.com/perappu)) ([PR #1517](https://github.com/lk-arpg/lorekeeper/pull/1517))